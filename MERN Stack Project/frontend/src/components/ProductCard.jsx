  ...
  return (
    ...
    >
        ...
        <Box p={4}>
            ...
            <HStack spacing = {2}>
                <IconButton icon={<MdModeEdit size={20}/>} onClick={onOpen} colorScheme='blue' />
                <IconButton icon={<MdDeleteForever size={20}/>} onClick={() => handleDeleteProduct(product._id)} colorScheme='red' />
            </HStack>
        </Box>
